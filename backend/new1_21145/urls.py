...
admin.site.site_header = "New1"
admin.site.site_title = "New1 Admin Portal"
admin.site.index_title = "New1 Admin"

# swagger
api_info = openapi.Info(
    title="New1 API",
    default_version="v1",
    description="API documentation for New1 App",
)
